...
func (t *Target) FormatSchema(_ context.Context, s messageflow.Schema) (messageflow.FormattedSchema, error) {
	...
	if err != nil {
		return messageflow.FormattedSchema{}, fmt.Errorf("executing template: %w", err)
	}
